...
yields
    ...
    {"A"=>2.0.0, "B"=>3.0.0, "D"=>1.0.0, "C"=>1.0.0}

But not all (dependency graph, solution constraint) systems are
satisfiable, so we must return useful error information:
